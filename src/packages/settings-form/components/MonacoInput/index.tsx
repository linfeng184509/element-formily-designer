...
import { TextWidget, IconWidget, usePrefix, useTheme, defineComponent } from '@/packages/prototypes'
...
import * as monacoL from "monaco-editor"
import { ElTooltip as Tooltip } from 'element-plus'
import { parseExpression, parse } from '@babel/parser'
import { isNum, isStr, uid } from '@/packages/shared'
