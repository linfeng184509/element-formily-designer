...
import { ArrayItems } from '@/packages/components'
import { FoldItem } from '@/packages/settings-form'
import { ElSelect as Select, ElOption as Option } from 'element-plus'
import { isStr } from '@/packages/shared'
                    ...
                    <FoldItem
                        ...
                        v-slots={{
                            base: () => {
                                return (
                                    <Select
                                        modelValue={Array.isArray(props.value) ? undefined : props.value}
                                        {...{
                                            'onUpdate:modelValue': props.onChange
                                        }}
                                        clearable={true}
                                        placeholder={GlobalRegistry.getDesignerMessage('SettingComponents.ValidatorSetter.pleaseSelect')}
                                    >
                                        {GlobalRegistry.getDesignerMessage('SettingComponents.ValidatorSetter.formats').map(item => {
